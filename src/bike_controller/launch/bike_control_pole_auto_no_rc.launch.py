    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                # Keep in sync with bike_control_pole.launch.py
                'poles_ctr': [-5.0, -10.0, -16.0],
                'pole_wc': -5.0,
                'control_dt': 0.02,
                'log_dir': LOG_DIR,
                'wheel_radius': 0.0725,
                ...
                'drive_sign': -1.0,
                'max_steer_velocity': 5.0,
                # Soft cap OFF. Unwind OFF for recovery test.
                'sat_unwind_enable': True,
                'sat_unwind_roll_deg': 8.0,
                'sat_unwind_rate_rad_s': 4.0,
                'sat_steer_roll_gain': 1.6,
                'sat_steer_floor_deg': 10.0,
                'lqr_q_steer': 12.0,
                'lqr_q_roll': 120.0,
