"""Pole-placement launch (RC). Kickstands: speed-only via kickstand_speed."""
    ...
    return LaunchDescription([
        ...
        Node(
            ...
            parameters=[{
                ...
                # Keep in sync with bike_control_pole_auto_no_rc.launch.py
